...
docker run --name some-mariadb -v /home/centos/dbdata:/var/lib/mysql -e MYSQL_ROOT_PASSWORD=Qur3sh1 -p 3306:3306 -d mariadb:5.5

docker exec -it some-mariadb bash

mysql -u root -p
/var/lib/mysql : mysql -p checkorphan2 < checkorphan2.dump
